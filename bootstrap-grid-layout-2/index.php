...
if(isset($_POST{"submitButton"}))
{
    ...
    VALUES('$firstName','$lastName','$emailAddress','$phone','$message')");
}
if ($insertdata)
{
...
<body>
 ...
 <!-- end navigation bar -->
    <main class="p-5 mb-4 bg-light">
        <h1 style="padding-top:80px;">Welcome Cosmas Kung'u</h1>
        <p>
         ...
         <!-- contact us page -->
            <div class="row pt-5">
                ...
                <p>Lorem ipsum dolor sit amet
                    ...
                    Pariatur, ex amet sit accusamus corrupti dignissimos magni iste laudantium 
                    quae esse perspiciatis tempora totam accusantium impedit omnis illo consequuntur? 
                    Tempora, animi. Non quod aspernatur, qui cumque quo officiis
                     error dolore sit reprehenderit</p>
